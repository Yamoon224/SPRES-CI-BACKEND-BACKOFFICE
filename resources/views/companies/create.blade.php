    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="page-title-box d-flex-between flex-wrap gap-15">
                <h1 class="page-title fs-18 lh-1">@lang('locale.add', ['param'=>__('locale.company', ['suffix'=>app()->getLocale() == 'en' ? 'y' : ''])])</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-example1 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('companies.index') }}">@lang('locale.company', ['suffix'=>app()->getLocale() == 'en' ? 'ies' : 's'])</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('locale.add', ['param'=>''])</li>
                    </ol>
                </nav>
            </div>
        </div>
